...
public function DocumentCategorySave(Request $request)
        {   
          ...
          ///////////////////////USER RIGHT & CONTROL ///////////////////////////////////////////    
          $allow= check_role(session::get('UserID'),'Document Category','Create/List');
 ...
 public function DocumentCategoryEdit($id)
    {   
      ...
      ///////////////////////USER RIGHT & CONTROL ///////////////////////////////////////////    
          $allow= check_role(session::get('UserID'),'Document Category','Update');
           if($allow==0)
          {
        ...
        {   
            ...
            ///////////////////////USER RIGHT & CONTROL ///////////////////////////////////////////    
          $allow= check_role(session::get('UserID'),'Document Category','Delete');
          if($allow==0)
          {
