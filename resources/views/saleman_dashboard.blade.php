                            ...
                            <div class="col-12">
                                <div class="page-title-box d-print-block d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Party Balances</h4>
                                        <strong class="text-end"><div align="center"> </div></strong> 
  ...
  <table  class="table table-striped table-sm" >
    <tr>
      ...
      <td width="40%" bgcolor="#CCCCCC"><div align="left"><strong>NAME</strong></div></td>
       <td width="16%" bgcolor="#CCCCCC"><div align="right"><strong>INVOICE</strong></div></td>
      <td width="16%" bgcolor="#CCCCCC"><div align="right"><strong> PAYMENT </strong></div></td>
...
$sql[0]->Balance = ($sql[0]->Balance ==null) ? '0' :  $sql[0]->Balance;
 ...
 ?>
    ...
    <tr>
      ...
      <td> <a href="{{URL('/PartySalesLedger22PDF/'.$value->PartyID)}}" >{{$value->PartyName}}</a></td>
