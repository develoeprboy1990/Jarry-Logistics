      ...
      <div class="card-body">
       ...
       <div class="table-responsive">
        ...
        @foreach ($chartofaccount_L1 as $key =>$value)
         ...
         <td class="col-md-1"  align="left"><a href="#"><i class="bx bx-lock-alt align-middle me-1 text-danger"></i></a> </td>
         </tr>
         ...
         <td class="col-md-1">
          ...
          @if($value1->Status!='LOCK')

          <a href="{{URL('/ChartOfAccountEdit/'.$value1->ChartOfAccountID)}}"><i class="bx bx-pencil align-middle me-1"></i></a> <a href="#" onclick="delete_confirm2('ChartOfAccountDelete',{{$value1->ChartOfAccountID}})"><i class="bx bx-trash  align-middle me-1"></i></a>
        @else
        <i class="bx bx-lock-alt align-middle me-1 text-danger"></i>
        @endif
         ...
         <td class="col-md-1">
          @if($value2->Status!='LOCK')

          <a href="{{URL('/ChartOfAccountEdit/'.$value2->ChartOfAccountID)}}"><i class="bx bx-pencil align-middle me-1"></i></a> <a href="#" onclick="delete_confirm2('ChartOfAccountDelete',{{$value2->ChartOfAccountID}})"><i class="bx bx-trash  align-middle me-1"></i></a>
          @else
          <i class="bx bx-lock-alt align-middle me-1 text-danger"></i>
          @endif
