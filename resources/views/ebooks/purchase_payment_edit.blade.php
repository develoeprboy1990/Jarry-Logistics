...
<!-- enctype="multipart/form-data" -->
  <form action="{{URL('/PurchasePaymentUpdate')}}" enctype="multipart/form-data" method="post"> 

    {{csrf_field()}} 

         
<input type="hidden" name="PurchasePaymentMasterID" value="{{request()->id}}">
...
<div class="col-md-8">
                 ...
                 <div class="row mb-4">
                   ...
                   <select name="SupplierID" id="SupplierID" class="form-select select2">
                       ...
                       <option value="{{$value->SupplierID}}" {{($value->SupplierID== $purchasepayment_master[0]->SupplierID) ? 'selected=selected':'' }}>{{$value->SupplierName}}</option>
                      @endforeach
                  </select>
                   </div> 
   ...
   <div class="row mb-4">
                   ...
                   <div class="input-group" id="datepicker21">
                    <input type="text" name="PaymentDate" autocomplete="off" class="form-control" placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" data-date-container="#datepicker21" data-provide="datepicker" data-date-autoclose="true" value="{{$purchasepayment_master[0]->PaymentDate}}">
        ...
        <div class="row mb-4">
                   ...
                   <div class="col-sm-9">
                   <input type="text" class="form-control" id="horizontal-firstname-input" name="PaymentMasterID" value="{{$purchasepayment_master[0]->PurchasePaymentMasterID}}">
                   </div>
                   </div>   
   ...
   <div class="row mb-4">
                   ...
                   <div class="col-sm-9">
                      <select name="PaymentMode" id="" class="form-select">
                       ...
                       <option value="{{$value->ChartOfAccountID}}" {{($value->ChartOfAccountID== $purchasepayment_master[0]->ChartOfAccountID) ? 'selected=selected':'' }}>{{$value->ChartOfAccountID}}-{{$value->ChartOfAccountName}}</option>
                      @endforeach 
                  </select>
                   </div>
                   </div>
     ...
     <div class="row mb-4">
                   ...
                   <div class="col-sm-9">
                   <input type="text" class="form-control" id="horizontal-firstname-input" name="ReferenceNo" value="{{$purchasepayment_master[0]->ReferenceNo}}" >
                   </div>
                   </div> 
...
<div class="col-sm-8">
  @if(count($purchasepayment_detail)>0)    
...
@foreach ($purchasepayment_detail as $key =>$value)
...
<textarea id="verticalnav-address-input" class="form-control" rows="" name="Notes">{{$purchasepayment_master[0]->Notes}}</textarea>
</div>
</div>
