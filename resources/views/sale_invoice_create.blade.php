                                    ...
                                    <tbody>
                                        <tr class="p-3">
                                          ...
                                          <input type="hidden" name="Qty[]" id="Qty_1" class=" form-control changesNo QtyTotal" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" step="0.01" value="1">                                         
                                                                                       ...
                                                                                       <td valign="top">
                                          <input type="text" name="Weight[]" id="Weight_1" class=" form-control" autocomplete="off"  value="">                                            </td>


                                            <td valign="top">
                                          <input type="text" name="Freight[]" id="Freight_1" class=" form-control" autocomplete="off"  value="">                                            </td>

                                            <td valign="top">
                                          <input type="text" name="Vat[]" id="Vat_1" class=" form-control" autocomplete="off"  value="">                                            </td>
