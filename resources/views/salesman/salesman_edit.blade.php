...
<input type="hidden" name="SalesmanID" value="{{$salesman[0]->SalesmanID}}">


            <div class="col-md-4">
          <div class="mb-3">
          <label for="basicpill-firstname-input">Name*</label>
          <input type="text" class="form-control" name="SalesmanName" value="{{$salesman[0]->SalesmanName}}" required="">
          </div>
          </div>
